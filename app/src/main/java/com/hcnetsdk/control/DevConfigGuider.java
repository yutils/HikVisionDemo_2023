...
//		HCNetSDK.getInstance().NET_DVR_SetSimAbilityPath(path, strSDCard);
    ...
    public static void Test_DDNSPara(int iUserID) {
        ...
        struDDNS.struDDNS[4].sDomainName = string2ASCII("111222333444", 64);
    ...
    public CGReturn Test_FindFile_jni(int iUserID) {
        ...
        while (findNext != -1) {
            ...
            if (findNext == HCNetSDK.NET_DVR_FILE_SUCCESS) {
                System.out.println("~~~~~Find File" + toValidString(new String(struFindData.sFileName)));
...
//        HCNetSDK.getInstance().NET_DVR_PlayBackControl_V50(nHandle, PlaybackControlCommand.NET_DVR_PLAY_CONVERT, compression, null);
    ...
    public CGReturn Test_Hikonline_jni() {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYSVR_BY_COUNTRYID, struCountryIDCond, struCountryIDRet)) {
            ret.status_1 = HCNetSDK.getInstance().NET_DVR_GetLastError();
            System.out.println("QUERYSVR_BY_COUNTRYID succ,resolve:" + toValidString(new String(struCountryIDRet.szResolveSvrAddr)));
        } else {
            ret.status_1 = HCNetSDK.getInstance().NET_DVR_GetLastError();
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_NICKNAME_DDNS, struDDNSCond, struDDNSQueryRet)) {
            ret.status_2 = HCNetSDK.getInstance().NET_DVR_GetLastError();
            System.out.println("QUERYDEV_BY_NICKNAME_DDNS succ,ip:" + toValidString(new String(struDDNSQueryRet.szDevIP)) + ", SDK port:" + struDDNSQueryRet.wCmdPort + ", http port" + struDDNSQueryRet.wHttpPort);
        } else {
            ret.status_2 = HCNetSDK.getInstance().NET_DVR_GetLastError();
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_SERIAL_DDNS, struDDNSCond, struDDNSQueryRet)) {
            ret.status_3 = HCNetSDK.getInstance().NET_DVR_GetLastError();
            System.out.println("QUERYDEV_BY_SERIAL_DDNS succ,ip:" + toValidString(new String(struDDNSQueryRet.szDevIP)) + ", SDK port:" + struDDNSQueryRet.wCmdPort + ", http port" + struDDNSQueryRet.wHttpPort);
        } else {
            ret.status_3 = HCNetSDK.getInstance().NET_DVR_GetLastError();
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.CHECKDEV_BY_NICKNAME_DDNS, struDDNSCond, struDDNSCheckRet)) {
            System.out.println("CHECKDEV_BY_NICKNAME_DDNS succ,ip:" + toValidString(new String(struDDNSCheckRet.struQueryRet.szDevIP)) + ", SDK port:" + struDDNSCheckRet.struQueryRet.wCmdPort + ", http port" + struDDNSCheckRet.struQueryRet.wHttpPort + ",region:" + struDDNSCheckRet.wRegionID + ",status:" + struDDNSCheckRet.byDevStatus);
        } else {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.CHECKDEV_BY_SERIAL_DDNS, struDDNSCond, struDDNSCheckRet)) {
            System.out.println("CHECKDEV_BY_SERIAL_DDNS succ,ip:" + toValidString(new String(struDDNSCheckRet.struQueryRet.szDevIP)) + ", SDK port:" + struDDNSCheckRet.struQueryRet.wCmdPort + ", http port" + struDDNSCheckRet.struQueryRet.wHttpPort + ",region:" + struDDNSCheckRet.wRegionID + ",status:" + struDDNSCheckRet.byDevStatus);
        } else {
    ...
    public CGReturn Test_IPServer_jni() {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_NICKNAME_IPSERVER, struIPServerCond, struIPServerRet)) {
            ret.status_1 = HCNetSDK.getInstance().NET_DVR_GetLastError();
            System.out.println("QUERYDEV_BY_NICKNAME_IPSERVER succ,ip:" + toValidString(new String(struIPServerRet.szDevIP)) + ", SDK port:" + struIPServerRet.wCmdPort);
        } else {
            ret.status_1 = HCNetSDK.getInstance().NET_DVR_GetLastError();
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_SERIAL_IPSERVER, struIPServerCond, struIPServerRet)) {
            ret.status_2 = HCNetSDK.getInstance().NET_DVR_GetLastError();
            System.out.println("QUERYDEV_BY_SERIAL_IPSERVER succ,ip:" + toValidString(new String(struIPServerRet.szDevIP)) + ", SDK port:" + struIPServerRet.wCmdPort);
        } else {
            ret.status_2 = HCNetSDK.getInstance().NET_DVR_GetLastError();
